#' Creates a list object of all the factor levels in correct order per column
#'
#' @return List object of string vectors of factor levels
#' @export
#'
create_factor_levels <- function() {
  ...
  list(
    ...
    agegrp_excess = c(
      "All ages", "0 to 29", "30 to 44", "45 to 49",
      "50 to 54", "55 to 59", "60 to 64", "65 to 69", "70 to 74", "75 to 79",
